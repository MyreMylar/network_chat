...
class ChatWindow(UIWindow):
    def __init__(self,
        ...
        self.chat_entry_vertical_space = 40
        ...
        self.chat_entry = UITextEntryLine(pygame.Rect(0,
                                                      self.text_block_rect.bottom,
                                                      self.rect.width - (self.shadow_width * 2),
                                                      self.chat_entry_vertical_space),
                                          manager=manager,
                                          container=self.get_container(),
                                          parent_element=self,
                                          object_id='#chat_entry')
    ...
    def rebuild(self):
        ...
        if self.chat_entry is not None:
            self.chat_entry.set_relative_position((0, self.text_block_rect.bottom))
